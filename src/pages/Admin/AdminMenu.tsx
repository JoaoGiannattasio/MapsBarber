...
const AdminMenu: React.FC = () => {
  ...
  // Função para abrir o currículo
  const openCurriculo = () => {
    Linking.openURL('https://manuellrds.github.io/meu-curriculo/').catch((err) =>
    ...
    <ScrollView contentContainerStyle={styles.container}>
      ...
      >
        <View style={styles.content}>
          ...
          {/* Novo botão para abrir o currículo */}
          <TouchableOpacity style={styles.button} onPress={openCurriculo}>
            <Text style={styles.buttonText}>Ver Meu Currículo</Text>
          </TouchableOpacity>
